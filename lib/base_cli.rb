# Adapted from base_cli.rb found in the samples directory of google-api-client. Also available at
# https://github.com/googleapis/google-api-ruby-client/blob/master/samples/cli/lib/base_cli.rb
